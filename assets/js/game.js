...
function reset() {
    ...
    $(".firstRow").css({
        "background-color": "white", "outline-color": "limegreen",
...
var characters = {
    ...
    ObiWan: {
        name: "ObiWan",
        visual: 'assets/image/ObiWan.jpg',
        healthPoints: 120,
        attackPower: 8,
    ...
    LukeSky: {
        name: "LukeSky",
        visual: 'assets/image/LukeSkywalker.jpg',
        healthPoints: 100,
        attackPower: 10,
    ...
    DarSid: {
        name: "DarSid",
        visual: 'assets/image/DarthSidious.png',
        healthPoints: 150,
        attackPower: 10,
    ...
    DarMaul: {
        name: "DarMaul",
        visual: 'assets/image/DarthMaul.png',
        healthPoints: 180,
        attackPower: 12,
        fullName: "Darth Maul",
...
$(document).ready(function () {
    ...
    $(".firstRow").click(function () {
        ...
        for (var i = 0; i < 4; i++) {
            ...
            $("._" + [i]).not(myChar).css({
                "background-color": "red", "outline-color": "black",
